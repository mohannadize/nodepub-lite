...
const markup = {
  ...
  getCSS: (document) => {
    let baseCSS = ``;
    if (isRTLLanguage(document.metadata.language)) {
      baseCSS += `
    body, html {
      text-align: right;
      direction: rtl;
  ...
  getSection: (document, sectionNumber) => {
    ...
    result += "<html xmlns='http://www.w3.org/1999/xhtml'>[[EOL]]";
    result +=
      "  <head profile='http://dublincore.org/documents/dcmi-terms/'>[[EOL]]";
    result +=
      "    <meta http-equiv='Content-Type' content='text/html;' />[[EOL]]";
    result += `    <title>[[TITLE]] - ${title}</title>[[EOL]]`;
    result += "    <meta name='DCTERMS.title' content='[[TITLE]]' />[[EOL]]";
    result +=
      "    <meta name='DCTERMS.language' content='[[LANGUAGE]]' scheme='DCTERMS.RFC4646' />[[EOL]]";
    result += "    <meta name='DCTERMS.source' content='MFW' />[[EOL]]";
    result +=
      "    <meta name='DCTERMS.issued' content='{$issued}' scheme='DCTERMS.W3CDTF'/>[[EOL]]";
    result += "    <meta name='DCTERMS.creator' content='[[AUTHOR]]'/>[[EOL]]";
    result += "    <meta name='DCTERMS.contributor' content='' />[[EOL]]";
    result +=
      "    <meta name='DCTERMS.modified' content='{$issued}' scheme='DCTERMS.W3CDTF'/>[[EOL]]";
    result += "    <meta name='DCTERMS.provenance' content='' />[[EOL]]";
    result += "    <meta name='DCTERMS.subject' content='[[GENRE]]' />[[EOL]]";
    result +=
      "    <link rel='schema.DC' href='http://purl.org/dc/elements/1.1/' hreflang='en' />[[EOL]]";
    result +=
      "    <link rel='schema.DCTERMS' href='http://purl.org/dc/terms/' hreflang='en' />[[EOL]]";
    result +=
      "    <link rel='schema.DCTYPE' href='http://purl.org/dc/dcmitype/' hreflang='en' />[[EOL]]";
    result +=
      "    <link rel='schema.DCAM' href='http://purl.org/dc/dcam/' hreflang='en' />[[EOL]]";
    result +=
      "    <link rel='stylesheet' type='text/css' href='../css/ebook.css' />[[EOL]]";
    result += "  </head>[[EOL]]";
    result += "  <body>[[EOL]]";
